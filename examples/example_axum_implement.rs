...
mod out {
	...
	*/
	...
	pub trait ApiInterface {
		...
		fn device_get(
			&self,
			_req: DeviceGetRequest,
		) -> impl Future<Output = DeviceGetResponse> + Send {
			async { Default::default() }
		}
		// post /device/{key}
		fn device_update(
		...
		fn record_get(
			&self,
			_req: RecordGetRequest,
		) -> impl Future<Output = RecordGetResponse> + Send {
			async { Default::default() }
		}
		// post /record/{key}
		fn record_update(
						...
						OperationCleanResponse::Status200(v) => axum::response::Response::builder()
							...
							.body(axum::body::Body::from(
								serde_json::to_vec_pretty(&v)
									.expect("error serialize response json"),
							))
							.unwrap(),
			...
			axum::routing::post(
				|path: axum::extract::Path<HashMap<String, String>>,
				 ...
				 request: axum::http::Request<axum::body::Body>| async move {
					...
					let ret = S::credential_sign_in(
						...
						CredentialSignInRequest {
								...
								.and_then(|v| serde_json::from_slice(&v).map_err(|v| v.to_string()))
							{
								Ok(v) => v,
								Err(v) => {
									return text_response(axum::http::StatusCode::BAD_REQUEST, v)
								}
							},
							request: axum::http::Request::from_parts(
								parts.clone(),
					...
					.await;
					match ret {
						CredentialSignInResponse::Status200(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(200).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "application/json")
								.body(axum::body::Body::from(
						...
						CredentialSignInResponse::Status400(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(400).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "text/plain")
								.body(axum::body::Body::from(v))
						...
						CredentialSignInResponse::Status404(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(404).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "text/plain")
								.body(axum::body::Body::from(v))
			...
			axum::routing::post(
				|path: axum::extract::Path<HashMap<String, String>>,
				 ...
				 request: axum::http::Request<axum::body::Body>| async move {
					...
					.await;
					match ret {
						CredentialSignUpResponse::Status200(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(200).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "application/json")
								.body(axum::body::Body::from(
						...
						CredentialSignUpResponse::Status400(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(400).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "text/plain")
								.body(axum::body::Body::from(v))
						...
						CredentialSignUpResponse::Status404(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(404).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "text/plain")
								.body(axum::body::Body::from(v))
			...
			axum::routing::get(
				|path: axum::extract::Path<HashMap<String, String>>,
				 ...
				 request: axum::http::Request<axum::body::Body>| async move {
					...
					.await;
					match ret {
						CredentialValidateResponse::Status200(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(200).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "application/json")
								.body(axum::body::Body::from(
						...
						CredentialValidateResponse::Status400(v) => {
							axum::response::Response::builder()
								.status(axum::http::StatusCode::from_u16(400).unwrap())
								.header(axum::http::header::CONTENT_TYPE, "text/plain")
								.body(axum::body::Body::from(v))
