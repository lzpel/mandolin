...
pub trait ApiInterface {
	...
	fn credential_get(
		&self,
		_req: CredentialGetRequest,
	) -> impl Future<Output = CredentialGetResponse> + Send {
		async { Default::default() }
	}
	// post /credential/sign_in
	fn credential_sign_in(
		&self,
		_req: CredentialSignInRequest,
	) -> impl Future<Output = CredentialSignInResponse> + Send {
		async { Default::default() }
	}
	// post /credential/sign_up
	fn credential_sign_up(
		&self,
		_req: CredentialSignUpRequest,
	) -> impl Future<Output = CredentialSignUpResponse> + Send {
		async { Default::default() }
	}
	// get /credential/validate
	fn credential_validate(
		&self,
		_req: CredentialValidateRequest,
	) -> impl Future<Output = CredentialValidateResponse> + Send {
		async { Default::default() }
	}
	// get /device
	fn device_list_get(
		&self,
		_req: DeviceListGetRequest,
	) -> impl Future<Output = DeviceListGetResponse> + Send {
		async { Default::default() }
	}
	// post /device
	fn device_list_add(
		&self,
		_req: DeviceListAddRequest,
	) -> impl Future<Output = DeviceListAddResponse> + Send {
		async { Default::default() }
	}
	// get /device/{key}
	fn device_get(&self, _req: DeviceGetRequest) -> impl Future<Output = DeviceGetResponse> + Send {
		async { Default::default() }
	}
	// post /device/{key}
	fn device_update(
		&self,
		_req: DeviceUpdateRequest,
	) -> impl Future<Output = DeviceUpdateResponse> + Send {
		async { Default::default() }
	}
	// delete /device/{key}
	fn device_delete(
		&self,
		_req: DeviceDeleteRequest,
	) -> impl Future<Output = DeviceDeleteResponse> + Send {
		async { Default::default() }
	}
	// get /key/{key}
	fn operation_key(
		&self,
		_req: OperationKeyRequest,
	) -> impl Future<Output = OperationKeyResponse> + Send {
		async { Default::default() }
	}
	// post /ml/image
	fn ml_image(&self, _req: MlImageRequest) -> impl Future<Output = MlImageResponse> + Send {
		async { Default::default() }
	}
	// post /ml/json
	fn ml_json(&self, _req: MlJsonRequest) -> impl Future<Output = MlJsonResponse> + Send {
		async { Default::default() }
	}
	// get /record
	fn record_list_get(
		&self,
		_req: RecordListGetRequest,
	) -> impl Future<Output = RecordListGetResponse> + Send {
		async { Default::default() }
	}
	// post /record
	fn record_list_add(
		&self,
		_req: RecordListAddRequest,
	) -> impl Future<Output = RecordListAddResponse> + Send {
		async { Default::default() }
	}
	// get /record/{key}
	fn record_get(&self, _req: RecordGetRequest) -> impl Future<Output = RecordGetResponse> + Send {
		async { Default::default() }
	}
	// post /record/{key}
	fn record_update(
		&self,
		_req: RecordUpdateRequest,
	) -> impl Future<Output = RecordUpdateResponse> + Send {
		async { Default::default() }
	}
	// delete /record/{key}
	fn record_delete(
		&self,
		_req: RecordDeleteRequest,
	) -> impl Future<Output = RecordDeleteResponse> + Send {
		async { Default::default() }
	}
	// get /test
	fn test_b(&self, _req: TestBRequest) -> impl Future<Output = TestBResponse> + Send {
		async { Default::default() }
	}
	// put /test
	fn test_d(&self, _req: TestDRequest) -> impl Future<Output = TestDResponse> + Send {
		async { Default::default() }
	}
	// post /test
	fn test_c(&self, _req: TestCRequest) -> impl Future<Output = TestCResponse> + Send {
		async { Default::default() }
	}
	// delete /test
	fn test_a(&self, _req: TestARequest) -> impl Future<Output = TestAResponse> + Send {
		async { Default::default() }
	}
	// get /user
	fn user_list_get(
		&self,
		_req: UserListGetRequest,
	) -> impl Future<Output = UserListGetResponse> + Send {
		async { Default::default() }
	}
	// get /user/{key}
	fn user_get(&self, _req: UserGetRequest) -> impl Future<Output = UserGetResponse> + Send {
		async { Default::default() }
	}
	// post /user/{key}
	fn user_update(
		&self,
		_req: UserUpdateRequest,
	) -> impl Future<Output = UserUpdateResponse> + Send {
		async { Default::default() }
	}
	// delete /user/{key}
	fn user_delete(
		&self,
		_req: UserDeleteRequest,
	) -> impl Future<Output = UserDeleteResponse> + Send {
		async { Default::default() }
	}
}
/*
		...
		axum::routing::delete(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				let ret = S::operation_clean(
					i.as_ref(),
					OperationCleanRequest {
						request: axum::http::Request::from_parts(parts.clone(), Default::default()),
					},
				)
				.await;
				match ret {
					OperationCleanResponse::Status200(v) => axum::response::Response::builder()
						...
						.unwrap(),
					OperationCleanResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					CredentialGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					CredentialGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					CredentialGetResponse::Status404(v) => axum::response::Response::builder()
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					CredentialSignInResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					CredentialSignInResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					CredentialSignInResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					CredentialSignUpResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					CredentialSignUpResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					CredentialSignUpResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					CredentialValidateResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					CredentialValidateResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
	...
	let router = router.route(
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				let (parts, body) = request.into_parts();
				let ret = S::device_list_get(
					i.as_ref(),
					DeviceListGetRequest {
						r#limit: {
							let v = query.get("limit").and_then(|v| v.parse().ok());
							v
						},
						r#order: {
							let v = query.get("order").and_then(|v| v.parse().ok());
							v
						},
						r#max_key: {
							let v = query.get("max_key").and_then(|v| v.parse().ok());
							v
						},
						r#min_key: {
							let v = query.get("min_key").and_then(|v| v.parse().ok());
							v
						},
						request: axum::http::Request::from_parts(parts.clone(), Default::default()),
					},
				...
				.await;
				match ret {
					DeviceListGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					DeviceListGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					DeviceListGetResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
	...
	let router = router.route(
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				let (parts, body) = request.into_parts();
				let ret = S::device_list_add(
					i.as_ref(),
					DeviceListAddRequest {
						body: match axum::body::to_bytes(body, usize::MAX)
							.await
							.map_err(|v| format!("{v:?}"))
							.and_then(|v| serde_json::from_slice(&v).map_err(|v| v.to_string()))
				...
				.await;
				match ret {
					DeviceListAddResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					DeviceListAddResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
	...
	let router = router.route(
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				let (parts, body) = request.into_parts();
				let ret = S::device_get(
					i.as_ref(),
					DeviceGetRequest {
						r#key: {
							let v = path.get("key").and_then(|v| v.parse().ok());
							match v {
								Some(v) => v,
								None => {
									return text_response(
										axum::http::StatusCode::from_u16(400).unwrap(),
										format!("parse error: key in path={:?}", path),
									)
								}
							}
						},
				...
				.await;
				match ret {
					DeviceGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					DeviceGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					DeviceGetResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					DeviceUpdateResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					DeviceUpdateResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					DeviceUpdateResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::delete(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					DeviceDeleteResponse::Status200 => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from("The request has succeeded."))
						.unwrap(),
					DeviceDeleteResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					DeviceDeleteResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				let ret = S::operation_key(
					...
					OperationKeyRequest {
						...
						r#seconds: {
							let v = query.get("seconds").and_then(|v| v.parse().ok());
							v
						},
						request: axum::http::Request::from_parts(parts.clone(), Default::default()),
					},
				...
				.await;
				match ret {
					OperationKeyResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					OperationKeyResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
			...
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				let ret = S::ml_image(
					i.as_ref(),
					MlImageRequest {
						body: match axum::body::to_bytes(body, usize::MAX).await {
							Ok(v) => v.into(),
							Err(v) => {
								return text_response(
				...
				.await;
				match ret {
					MlImageResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					MlJsonResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
	...
	let router = router.route(
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				let (parts, body) = request.into_parts();
				let ret = S::record_list_get(
					i.as_ref(),
					RecordListGetRequest {
						r#limit: {
							let v = query.get("limit").and_then(|v| v.parse().ok());
							v
						},
						...
						r#key_device: {
							let v = query.get("key_device").and_then(|v| v.parse().ok());
							match v {
								Some(v) => v,
								None => {
									return text_response(
										axum::http::StatusCode::from_u16(400).unwrap(),
										format!("parse error: key_device in query={:?}", query),
									)
								}
							}
						},
				...
				.await;
				match ret {
					RecordListGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					RecordListGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
	...
	let router = router.route(
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				let (parts, body) = request.into_parts();
				let ret = S::record_list_add(
					i.as_ref(),
					RecordListAddRequest {
						r#key_device: {
							let v = query.get("key_device").and_then(|v| v.parse().ok());
							match v {
								Some(v) => v,
						...
						r#latitude: {
							let v = query.get("latitude").and_then(|v| v.parse().ok());
							match v {
								Some(v) => v,
								None => {
									return text_response(
										axum::http::StatusCode::from_u16(400).unwrap(),
										format!("parse error: latitude in query={:?}", query),
									)
								}
							}
						},
						r#longitude: {
							let v = query.get("longitude").and_then(|v| v.parse().ok());
							match v {
								Some(v) => v,
								None => {
									return text_response(
										axum::http::StatusCode::from_u16(400).unwrap(),
										format!("parse error: longitude in query={:?}", query),
									)
								}
							}
						},
				...
				.await;
				match ret {
					RecordListAddResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					RecordListAddResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					RecordGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					RecordGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					RecordGetResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					RecordUpdateResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					RecordUpdateResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					RecordUpdateResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::delete(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					RecordDeleteResponse::Status200 => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from("The request has succeeded."))
						.unwrap(),
					RecordDeleteResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					RecordDeleteResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				let ret = S::test_b(
					...
					TestBRequest {
						...
						r#cursor: {
							let v = query.get("cursor").and_then(|v| v.parse().ok());
							v
						},
						r#order: {
							let v = query.get("order").and_then(|v| v.parse().ok());
							match v {
								...
								None => {
									return text_response(
										axum::http::StatusCode::from_u16(400).unwrap(),
										format!("parse error: order in query={:?}", query),
									)
								}
							}
						},
				...
				.await;
				match ret {
					TestBResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::put(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					TestDResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					TestCResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::delete(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					TestAResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					UserListGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					UserListGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					UserListGetResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::get(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					UserGetResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					UserGetResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					UserGetResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::post(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					UserUpdateResponse::Status200(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "application/json")
						.body(axum::body::Body::from(
							serde_json::to_vec_pretty(&v).expect("error serialize response json"),
						...
						.unwrap(),
					UserUpdateResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					UserUpdateResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
		...
		axum::routing::delete(
			|path: axum::extract::Path<HashMap<String, String>>,
			 ...
			 request: axum::http::Request<axum::body::Body>| async move {
				...
				.await;
				match ret {
					UserDeleteResponse::Status200 => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(200).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from("The request has succeeded."))
						.unwrap(),
					UserDeleteResponse::Status400(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(400).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
					UserDeleteResponse::Status404(v) => axum::response::Response::builder()
						.status(axum::http::StatusCode::from_u16(404).unwrap())
						.header(axum::http::header::CONTENT_TYPE, "text/plain")
						.body(axum::body::Body::from(v))
						.unwrap(),
